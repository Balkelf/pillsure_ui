      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground font-light">Manage your prescription schedule</p>
          </div>
          <Button 
            variant="default"
        ...
        <div className="space-y-6">
          ...
          <div>
            <h2 className="text-xl font-bold">Current Medication Schedule</h2>
            <p className="text-muted-foreground font-light">
              View and manage your medication schedule in the 
              <Button variant="link" className="p-0 h-auto font-normal ml-1" onClick={() => window.location.href="/device-settings"}>
                device settings
              </Button>
            </p>
          </div>
        ...
        <div className="space-y-4 mt-6">
          ...
          <div className="border rounded-lg overflow-hidden">
            ...
            >
              <div className="flex items-center justify-between w-full">
                <h3 className="text-2xl font-bold">Metformin 500mg</h3>
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
            ...
            >
              <div className="px-4 pb-4">
                ...
                <Card className="bg-blue-50 border-blue-200">
                  <CardContent className="p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="text-base font-medium leading-tight text-blue-800">Metformin Titration</h3>
                        <p className="text-sm text-blue-700 mt-1 leading-normal">
                ...
                <h3 className="text-lg font-semibold mt-6 mb-4">Metformin Titration Schedule</h3>
                    ...
                    <CardContent className="p-4">
                      <div className="flex gap-4">
                        ...
                        <div className="flex-1">
                          <h4 className="text-base font-medium leading-tight">Week 1: Metformin 500mg</h4>
                          <p className="text-sm text-muted-foreground font-light mt-1">Once daily</p>
                          <p className="text-sm text-muted-foreground font-light">Apr 10 - Apr 16, 2023</p>
                          <p className="text-sm text-muted-foreground font-light">Take with breakfast for the first week</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border">
                    <CardContent className="p-4">
                      <div className="flex gap-4">
                        ...
                        <div className="flex-1">
                          <h4 className="text-base font-medium leading-tight">Week 2: Metformin 500mg</h4>
                          <p className="text-sm text-muted-foreground font-light mt-1">Twice daily</p>
                          <p className="text-sm text-muted-foreground font-light">Apr 17 - Apr 23, 2023</p>
                          <p className="text-sm text-muted-foreground font-light">Take with breakfast and evening meal for the second week</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                      ...
                      <div className="flex gap-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-3">
                            <h4 className="text-base font-medium leading-tight">Week 3: Metformin 500mg</h4>
                            <span className="bg-blue-100 text-blue-600 px-3 py-0.5 rounded-full text-xs font-medium">Current</span>
                          </div>
                          <p className="text-sm text-muted-foreground font-light mt-1">Three times daily</p>
                          <p className="text-sm text-muted-foreground font-light">From Apr 24, 2023 onwards</p>
                          <p className="text-sm text-muted-foreground font-light">Take with breakfast, lunch and evening meal starting from the third week</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
          ...
          <div className="border rounded-lg overflow-hidden">
            ...
            >
              <h3 className="text-2xl font-bold">Lisinopril 10mg</h3>
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            >
              <div className="px-4 pb-4">
                <p className="text-gray-600 mb-4">For blood pressure management</p>
                {/* Additional content can be added here */}
              </div>
            </div>
            {openMedication !== "lisinopril" && (
              <div className="px-4 pb-1">
                <p className="text-gray-600">For blood pressure management</p>
              </div>
            )}
          </div>
          ...
          <div className="border rounded-lg overflow-hidden">
            ...
            >
              <h3 className="text-2xl font-bold">Atorvastatin 20mg</h3>
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            >
              <div className="px-4 pb-4">
                <p className="text-gray-600 mb-4">For cholesterol management, take in the evening</p>
                {/* Additional content can be added here */}
              </div>
            </div>
            {openMedication !== "atorvastatin" && (
              <div className="px-4 pb-1">
                <p className="text-gray-600">For cholesterol management, take in the evening</p>
              </div>
            )}
          </div>
        </div>
